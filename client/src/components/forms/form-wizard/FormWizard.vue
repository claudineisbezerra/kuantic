<template>
  <div class="form-wizard-page">
    <div class="va-row">
      <div class="flex md12">
        <kuantic-widget class="no-h-padding"
          ...
          <kuantic-wizard
            ...
            <div slot="page1" class="form-wizard-tab-content">
              ...
              <div class="form-group with-icon-right"
                   :class="{'has-error': veeErrors.has('hsName'), 'valid': isFormFieldValid('hsName')}">
                <div class="input-group">
                  ...
                  <small v-show="veeErrors.has('hsName')" class="help text-danger">
                    {{ veeErrors.first('hsName') }}
                  </small>
                </div>
              </div>
            </div>
        ...
        <kuantic-widget class="no-h-padding"
          ...
          <kuantic-wizard
            ...
            <div slot="page1" class="form-wizard-tab-content">
              ...
              <div class="form-group with-icon-right"
                   :class="{'has-error': veeErrors.has('hrName'), 'valid': isFormFieldValid('hrName')}">
                <div class="input-group">
                  <input
                    name="hrName"
                    data-vv-as="Name"
                  ...
                  <label class="control-label">{{'forms.wizard.name' |
                    translate}}</label><i class="bar"></i>
                  <small v-show="veeErrors.has('hrName')" class="help text-danger">
                    {{ veeErrors.first('hrName') }}
                  </small>
                </div>
              </div>
            </div>
    ...
    <div class="va-row">
      <div class="flex md12">
        <kuantic-widget :headerText="$t('forms.wizard.verticalRich')">
          <kuantic-wizard
            :steps="vrSteps"
            ...
            <div slot="page1" class="form-wizard-tab-content">
              ...
              <div class="form-group with-icon-right"
                   :class="{'has-error': veeErrors.has('vrName'), 'valid': isFormFieldValid('vrName')}">
                <div class="input-group">
                  <input
                    name="vrName"
                    data-vv-as="Name"
                  ...
                  <label class="control-label">{{'forms.wizard.name' |
                    translate}}</label><i class="bar"></i>
                  <small v-show="veeErrors.has('vrName')" class="help text-danger">
                    {{ veeErrors.first('vrName') }}
                  </small>
                </div>
              </div>
            </div>
    ...
    <div class="va-row">
      <div class="flex md12">
        <kuantic-widget class="simple-vertical-wizard-widget"
          ...
          <kuantic-wizard
            ...
            <div slot="page1" class="form-wizard-tab-content">
              ...
              <div class="form-group with-icon-right"
                   :class="{'has-error': veeErrors.has('vsName'), 'valid': isFormFieldValid('vsName')}">
                <div class="input-group">
                  <input
                    name="vsName"
                    data-vv-as="Name"
                  ...
                  <label class="control-label">{{'forms.wizard.name' |
                    translate}}</label><i class="bar"></i>
                  <small v-show="veeErrors.has('vsName')" class="help text-danger">
                    {{ veeErrors.first('vsName') }}
                  </small>
                </div>
              </div>
            </div>
