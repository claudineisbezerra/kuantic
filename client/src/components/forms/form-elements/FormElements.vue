<template>
  <div class="form-elements">
              ...
              <div class="flex md4">
                <fieldset>
                  ...
                  <div class="form-group with-icon-right"
                       :class="{'has-error': veeErrors.has('successfulEmail'), 'valid': isSuccessfulEmailValid}">
                    <div class="input-group">
                      <input
                        id="successfulEmail"
                      ...
                      class="bar"></i>
                      <small v-show="veeErrors.has('successfulEmail')" class="help text-danger">
                        {{ veeErrors.first('successfulEmail') }}
                      </small>
                    </div>
                  </div>
                  <div class="form-group with-icon-right"
                       :class="{'has-error': veeErrors.has('wrongEmail')}">
                    <div class="input-group">
                      <input
                        id="wrongEmail"
                        name="wrongEmail"
                      ...
                      <i
                        ...
                        v-show="veeErrors.has('wrongEmail')"></i>
                      <label class="control-label" for="wrongEmail">{{'forms.inputs.emailValidated'
                        | translate}}</label><i class="bar"></i>
                      <small v-show="veeErrors.has('wrongEmail')"
                             class="help text-danger">{{
                        veeErrors.first('wrongEmail')
                        }}
                      </small>
                    </div>
                  </div>
                  ...
                  <div class="form-group with-icon-left">
                    <div class="input-group">
                      ...
                      <label class="control-label" for="input-icon-left">
                        {{'forms.inputs.inputWithIcon' | translate}}</label><i class="bar"></i>
                    </div>
                  </div>
                  <div class="form-group with-icon-right">
                    <div class="input-group">
    ...
    <div class="va-row">
      <div class="flex md12">
        <kuantic-widget :headerText="$t('forms.dateTimePicker.title')">
          <form>
            <div class="va-row">
              <div class="flex md4">
                <fieldset>
    ...
    <div class="va-row">
      <div class="flex md12">
        <kuantic-widget :headerText="'forms.selects.title' | translate">
          <form>
            <div class="va-row">
              <div class="flex md4">
                <fieldset>
    ...
    <div class="va-row">
      <div class="flex md12">
        <kuantic-widget :headerText="'forms.controls.title' | translate">
          <form>
            <div class="va-row">
              <div class="flex md3">
                <fieldset>
