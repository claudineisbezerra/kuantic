  ...
  <div>
    <div class="va-row">
      <div class="flex xs12 md12">
        <kuantic-widget :headerText="$t('tables.basic')">
    ...
    <div class="va-row">
      <div class="flex md12 xs12">
        <kuantic-widget :headerText="$t('tables.styled')">
          <div class="table-responsive">
    ...
    <div class="va-row">
      <div class="flex md12 xs12">
        <kuantic-widget :headerText="$t('tables.advanced')">
          <kuantic-data-table
            :apiUrl="apiUrl"
...
import FieldsDef
  from '../../kuantic-theme/kuantic-components/kuantic-datatable/data/fields-definition'
import ItemsPerPageDef
  from '../../kuantic-theme/kuantic-components/kuantic-datatable/data/items-per-page-definition'
import QueryParams from '../../kuantic-theme/kuantic-components/kuantic-datatable/data/query-params'
