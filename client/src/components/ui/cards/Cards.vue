  ...
  <div>
    ...
    <div class="flex md12 align--center justify--center">
      <div class="pre-loader-container">
        <kuantic-pre-loader v-show="isShown"
                            class="pre-loader"></kuantic-pre-loader>
        <div v-if="!isShown">
...
<script>
import KuanticCard
  from '../../../kuantic-theme/kuantic-components/kuantic-card/KuanticCard'

export default {
  name: 'cards',
  components: { KuanticCard },
  data () {
    return {
      listLoops: 1,
      isShown: false,
