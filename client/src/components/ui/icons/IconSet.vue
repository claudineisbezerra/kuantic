<template>
  <div class="kuantic-icon-set">
    <kuantic-widget class="kuantic-icon-set__header">
      <div class="va-row">
        <div class=" flex md4 xs12 kuantic-icon-set__header__text">
          <h2>{{ set.name }}</h2>
        ...
        <div class="flex md4 xs12 kuantic-icon-set__header__range">
          <h4>A</h4>
          <kuantic-slider
            :options="slider"
            v-model="iconSize"
