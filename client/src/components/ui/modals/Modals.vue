<template>
  <div class="modals-page">
    <div class="va-row">
      <div class="flex md12">
        <kuantic-widget class="modals-list larger-padding"
    ...
    <!--//Modals-->
    <kuantic-modal :show.sync="show" ref="smallModal" v-bind:small="true"
                   :cancelClass="'none'"
    ...
    <kuantic-modal :show.sync="show" ref="mediumModal"
                   :okText="'modal.confirm' | translate"
                   :cancelText="'modal.cancel' | translate">
    ...
    <kuantic-modal :show.sync="show" v-bind:large="true" ref="largeModal"
                   :okText="'modal.confirm' | translate"
                   :cancelText="'modal.cancel' | translate">
