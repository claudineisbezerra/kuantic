<template>
  <div class="va-row spinners">
    <div class="flex md12 xs12">
      <kuantic-widget :headerText="$t('spinners.title')"
        ...
        <div class="spinners__customization">
          <div class="va-row">
            <div class="flex md3 lg4">
              <div class="row spinners__size">
                ...
                <div class="spinners__size-picker">
                  <kuantic-slider v-model="config.size" :options="sliderSize"/>
                </div>
            ...
            <div class="flex md3 lg4">
              <div class="va-row spinners__duration">
                ...
                <div class="spinners__duration-picker">
                  <kuantic-slider v-model="currentDuration"
            ...
            <div class="flex md6 lg4 xs4 spinners__color">
              <kuantic-pallet-custom :palette="paletteArray" v-model="color"
...
import KuanticPalletCustom
  from '../../../kuantic-theme/kuantic-components/kuantic-color-picker/KuanticPalletCustom'
import { colorArray } from '../../../kuantic-theme/kuantic-components/kuantic-color-picker/KuanticTheme'
import KuanticSlider
  from '../../../kuantic-theme/kuantic-components/kuantic-slider/KuanticSlider'
import KuanticIconFaster
  from '../../../kuantic-theme/kuantic-components/kuantic-icon/KuanticIconFaster'
import KuanticIconSlower
  from '../../../kuantic-theme/kuantic-components/kuantic-icon/KuanticIconSlower'
