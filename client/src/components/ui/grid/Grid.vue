<template>
  <div class="ui-grid va-row">
    <div class="flex xs12 md12">
      <kuantic-widget headerText="Fixed Grid">
        <div>
          <div class="va-row">
            <div class="flex xs12">
    ...
    <div class="flex md12 xs12">
      <kuantic-widget headerText="Desktop Grid">
        <div class="va-row">
          <div class="flex xs4" v-for="i in 3" :key="`4${i}`">
            <div class="_green-rectangle">
              xs4
    ...
    <div class="flex md12 xs12">
      <kuantic-widget headerText="Mobile and Desktop Grid">
        <div class="va-row">
    ...
    <div class="flex md12 xs12">
      <kuantic-widget headerText="Offsets">
        <div class="va-row">
