<template>
  <div class="notifications-page">
          ...
          <div class="va-row">
            <div class="flex md6">
              <fieldset>
                ...
                <kuantic-popover popover-class="kuantic-tooltip"
                                 placement="right"
            ...
            <div class="flex md6">
              <p>
                ...
                <kuantic-tooltip :options="topTooltipOptions"><a href="#">{{'notificationsPage.popovers.topTooltip'
                  | translate}}</a></kuantic-tooltip>
                showcase. Just anything you can possibly imagine to test
                <kuantic-tooltip :options="rightTooltipOptions"><a href="#">{{'notificationsPage.popovers.rightTooltip'
                  | translate}}</a></kuantic-tooltip>
                .
                But it can appear on the
                <kuantic-tooltip :options="leftTooltipOptions"><a href="#">{{'notificationsPage.popovers.leftTooltip'
                  | translate}}</a></kuantic-tooltip>
                .
                Or just
                <kuantic-tooltip :options="bottomTooltipOptions"><a href="#">{{'notificationsPage.popovers.bottomTooltip'
                  | translate}}</a></kuantic-tooltip>
                the item.
              </p>
            </div>
    ...
    <div class="va-row">
      <div class="flex md12">
        <kuantic-widget
          ...
          <kuantic-alert type="success" :withCloseBtn="true">
          ...
          <kuantic-alert type="info" :withCloseBtn="true">
          ...
          <kuantic-alert type="warning" :withCloseBtn="true">
          ...
          <kuantic-alert type="danger" :withCloseBtn="true">
    ...
    <div class="va-row">
      <div class="flex xs12">
        <kuantic-widget :headerText="$t('notificationsPage.toasts.title')">
          <div class="va-row">
            ...
            <div class="flex xs12 md6 flex-center">
              ...
              >
                <div class="toasted kuantic-toast none default">
