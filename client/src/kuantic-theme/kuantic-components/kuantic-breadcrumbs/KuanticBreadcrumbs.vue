<template>
  <div class="kuantic-breadcrumbs">
    <div class="kuantic-breadcrumbs__nav-section">
      <router-link
        class="kuantic-breadcrumbs__nav-section-item"
    ...
    <div class="kuantic-breadcrumbs__help-section">
      <a
        target="_blank"
        :href="currentRoute"
        class="btn btn-micro btn-info"
      >
        <span class="kuantic-icon kuantic-icon-files"/>
      </a>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    currentRoute () {
      return this.$route.meta.wikiLink || 'https://github.com/claudineisbezerra/kuantic/wiki'
    },
  },
  methods: {
...
.kuantic-breadcrumbs {
  ...
  .kuantic-breadcrumbs__nav-section-item {
    color: $text-gray;
  ...
  .kuantic-breadcrumbs__help-section {
    .kuantic-icon {
      font-size: 20px;
    }
  }
