...
.kuantic-timeline {
  ...
  &:not(.kuantic-timeline--vertical) {
    padding-top: $timeline-outer-spacing;
    padding-bottom: $timeline-outer-spacing;
  }
  .kuantic-timeline-item {
    flex: 1;
  }
  .kuantic-timeline-item--vertical {
    .kuantic-timeline-separator--vertical .kuantic-timeline-separator__line {
      &:first-child {
        flex: 0 0 1rem;
      }
    }

    &.kuantic-timeline-item--is-first {
      .kuantic-timeline-separator--vertical .kuantic-timeline-separator__line {
        &:first-child {
          flex-basis: 2rem;
        }
      ...
      .kuantic-timeline-item__after, .kuantic-timeline-item__before {
        padding-top: $timeline-outer-spacing;
      }
    }
    &.kuantic-timeline-item--vertical.kuantic-timeline-item--is-last {
      .kuantic-timeline-item__after, .kuantic-timeline-item__before {
        padding-bottom: $timeline-outer-spacing;
      }
    }
  ...
  :not(.kuantic-timeline-item--vertical) {
    &.kuantic-timeline-item--is-first {
      .kuantic-timeline-item__after, .kuantic-timeline-item__before {
        padding-left: $timeline-outer-spacing;
      }
    }
    &.kuantic-timeline-item--is-last {
      .kuantic-timeline-item__after, .kuantic-timeline-item__before {
        padding-right: $timeline-outer-spacing;
      }
    }
