<template>
  <div class="kuantic-simple-select">
    <div
    ...
    >
      <div
        class="input-group dropdown-toggle kuantic-simple-select__dropdown-toggle">
        <div>
          <input
            @focus="showDropdown()"
        ...
        <i
          class="ion ion-ios-arrow-down icon-right input-icon kuantic-simple-select__dropdown-arrow"
          @click="showDropdown"
        />
      </div>
      <div v-if="isClearable">
        <i
          class="fa fa-close icon-cross icon-right input-icon kuantic-simple-select__unselect"
          @click="unselectOption"
        />
      </div>
      <div
        class="dropdown-menu kuantic-simple-select__dropdown-menu"
        aria-labelledby="dropdownMenuButton">
        <scrollbar ref="scrollbar">
          <div
            class="dropdown-menu-content kuantic-simple-select__dropdown-menu-content">
            <div
              class="dropdown-item kuantic-simple-select__dropdown-item"
...
import Scrollbar from '../kuantic-scrollbar/KuanticScrollbar.vue'

export default {
  name: 'kuantic-simple-select',
  components: {
    Scrollbar,
  },
  directives: {
...
.kuantic-simple-select {
  ...
  .kuantic-simple-select__dropdown-arrow.kuantic-simple-select__dropdown-arrow {
    top: 12px;
    cursor: pointer;
  }
