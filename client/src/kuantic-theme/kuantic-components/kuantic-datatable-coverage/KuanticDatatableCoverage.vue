<template>
  <div class="kuantic-data-table table-responsive"
    ...
    <vuetable
      ...
      <template slot="coverage_min" slot-scope="props">
        <div class="flex md6">
          <div class="form-group">
            <div class="input-group">
              <input  :name="'coverage_min_'+props.rowIndex"
                      v-model="props.rowData.coverage_min"
                      @change="onCellChange(props.rowData)"
                      v-validate="'numeric'"/>
              <i class="bar"></i>
              <small v-show="veeErrors.has('coverage_min_'+props.rowIndex)" class="help text-danger">
                {{ veeErrors.first('coverage_min_'+props.rowIndex) }}
              </small>
            </div>
          </div>
        </div>
      </template>
      <template slot="coverage_optimal" slot-scope="props">
        <div class="flex md6">
          <div class="form-group">
            <div class="input-group">
              <input  :name="'coverage_optimal_'+props.rowIndex"
                      v-model="props.rowData.coverage_optimal"
                      @change="onCellChange(props.rowData)"
                      v-validate="'numeric'"/>
              <i class="bar"></i>
              <small v-show="veeErrors.has('coverage_optimal_'+props.rowIndex)" class="help text-danger">
                {{ veeErrors.first('coverage_optimal_'+props.rowIndex) }}
              </small>
            </div>
          </div>
        </div>
      ...
      <template slot="actions" slot-scope="props">
        <div class="custom-actions">
          <button class="btn btn-tiny btn-outline-danger"
            @click="onAction('delete-item', props.rowData._id)">
