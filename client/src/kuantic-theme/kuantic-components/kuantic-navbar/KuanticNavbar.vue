<template>
  <nav class="kuantic-navbar navbar navbar-toggleable-md">
    <div
      class="kuantic-navbar__logo navbar-brand-container align--center justify--start">
      <router-link class="navbar-brand" to="/dashboard">
        <slot name="logo"/>
      </router-link>
    </div>
    <div class="va-row kuantic-navbar__content">
      <div
