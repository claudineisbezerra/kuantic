<template>
  <div class="kuantic-profile-card flex align--center">
    <div class="photo">
      <img :src="photoSource"/>
    </div>
...
<script>
export default {
  name: 'kuantic-profile-card',
  props: ['photoSource', 'name', 'location', 'social'],
}
</script>

<style lang="scss">
$kuantic-profile-card-width: 12.6875rem;
$kuantic-profile-card-photo-diameter: 9.375rem;

.kuantic-profile-card {
  width: $kuantic-profile-card-width;
  .photo {
    height: $kuantic-profile-card-photo-diameter;
    width: $kuantic-profile-card-photo-diameter;
    border-radius: 50%;
