...
/** Global server-side internationalization*/
const i18n = require('./plugins/i18n.js');
const LocaleService = require('./plugins/locale-service.js');
...
/** Trust Proto Header for heroku in production*/
if (process.env.NODE_ENV === 'production') {
...
/** Express server-side internationalization middleware*/
app.use(i18n.init);
app.use(localeService.changeLocale());
