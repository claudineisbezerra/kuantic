...
const populateData = async () => {
    ...
    //     await new SummaryProductVariantIndicator({
    ...
    //     }).save();
    // }
    // console.log('[PROCESS:FIN] Completed Seeding SummaryProductVariantIndicator Data');
    ...
    //     coverages: coverageSeedData,
    //     calculation: calculationSeedData
    // }).save();
